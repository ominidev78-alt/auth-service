 ...
 */
router.get('/admin/settings/maintenance', adminAuth, (req, res, next) => maintenanceController.adminGetStatus(req, res, next));
/**
 * @openapi
 * /api/admin/settings/maintenance:
 *   patch:
 ...
 *         $ref: '#/components/responses/InternalServerError'
 */
router.patch('/admin/settings/maintenance', adminAuth, (req, res, next) => maintenanceController.adminToggle(req, res, next));
