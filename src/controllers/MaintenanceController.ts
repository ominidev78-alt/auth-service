...
class MaintenanceController {
  async adminGetStatus(req: Request, res: Response, next: NextFunction) {
    try {
  ...
  async adminToggle(req: Request, res: Response, next: NextFunction) {
    try {
  ...
  async publicStatus(req: Request, res: Response, next: NextFunction) {
    try {
      const data = await MaintenanceModeModel.get()
